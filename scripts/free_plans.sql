...
WHERE OBJECT_NAME(st.objectid,st.dbid) = 'sp_InsertVitalsAndOnsiteTesting'

--DBCC FREEPROCCACHE (0x05000500DE8C4213606D59900400000001000000000000000000000000000000000000000000000000000000)
